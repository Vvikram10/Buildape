  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      cards.forEach((card) => {
        ...
        // Set initial state for the info panel to be off-screen below the card
        ...
        >
          <div className="flex space-x-6 w-max mx-auto pl-[calc(50vw-14rem)] pr-[calc(50vw-14rem)]">
            {products.map((product) => (
              ...
              //         <button className="add-to-cart-btn px-4 py-2 bg-orange-500 hover:bg-gray-800 text-white rounded-full transition-colors duration-200">
              //           Add to Cart
              //         </button>
              //       </div>
              //     </div>
