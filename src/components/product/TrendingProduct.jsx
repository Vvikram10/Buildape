    ...
    const ctx = gsap.context(() => {
      ...
      cards.forEach(card => {
        ...
        card.addEventListener('mouseenter', () => {
          ...
          // Optional: Fade out other elements slightly
          gsap.to([price, variant, name], {
            opacity: 0.7,
            duration: 0.3
          });
        });
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 bg-white z-20 border-t border-gray-200">
                  <div className="relative">
                    ...
                    <p className="product-variant text-sm text-gray-600 mb-2">{product.variant}</p>
                    <div className="flex justify-between items-center">
                      <span className="product-price text-orange-500 font-bold">{product.price}</span>
                      <button className="add-to-cart-btn px-4 py-2 bg-orange-500 text-white rounded-full hover:bg-gray-800 transition-all absolute bottom-0 right-0">
                        Add to Cart
                      </button>
                    </div>
                  </div>
