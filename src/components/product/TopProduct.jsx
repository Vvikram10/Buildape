...
// // // //       const collapsedWidth = isMobile ? "80vw" : `${(100 - 45) / (totalSections - 1)}%`;

// // // //       return {
// // // //         isMobile,
// // // //         expanded: { width: expandedWidth },
// // // //         collapsed: { width: isMobile ? "80vw" : "25%" },
// // // //         otherCollapsed: { width: collapsedWidth },
// // // //         image: {
// // // //           collapsedScale: 0.6,
// // // //           expandedScale: isMobile ? 0.9 : 1,
...
// // // //           overflowX: "auto",
// // // //         });
// // // //         gsap.set(shoeSections, { width: "80vw", height: "100%" });
// // // //       } else {
// // // //         gsap.set(".products-container", { width: "100%", overflowX: "hidden" });
// // // //         gsap.set(shoeSections, { width: collapsed.width, height: "100%" });
// // // //       }
...
// // // //       if (isMobile && isAlreadyActive) return; // Prevent closing on mobile
...
// // // //       <div className="products-container flex w-full h-full overflow-x-auto snap-x snap-mandatory md:overflow-x-hidden">
// // // //         {products.map((product) => (
// // // //           <div
// // // //             key={product.id}
// // // //             className="shoe-section relative overflow-hidden cursor-pointer p-4 flex flex-col justify-between snap-center flex-shrink-0"
// // // //             data-shoe={product.id}
// // // //             style={{ backgroundColor: product.bgColor }}
// // // //           >
// // // //             {/* NIKE Background Text */}
...
// // //       const isMobile = window.innerWidth < 1024; // Changed breakpoint for tablets/laptops
// // //       const totalSections = shoeSections.length;
// // //       const expandedWidth = isMobile ? "100vw" : "45%"; // Mobile sections take full width when clicked/snapped
// // //       const collapsedWidth = isMobile ? "80vw" : `${(100 - 45) / (totalSections - 1)}%`;

// // //       return {
// // //         isMobile,
// // //         expanded: { width: expandedWidth },
// // //         collapsed: { width: isMobile ? "80vw" : "25%" }, // Default mobile card width
// // //         otherCollapsed: { width: collapsedWidth },
// // //         image: {
// // //           collapsedScale: 0.6,
// // //           expandedScale: isMobile ? 0.9 : 1,
...
// // //       if (isMobile) {
// // //         gsap.set(".products-container", {
// // //           width: "100%", // On mobile, container width is 100% and scrolls
// // //           overflowX: "auto",
// // //           display: "flex", // Ensure flex for horizontal layout
// // //         });
// // //         gsap.set(shoeSections, {
// // //           width: "90vw", // Slightly smaller than 100vw to show next card
// // //           height: "90%", // Adjust height for mobile view if needed
// // //           flexShrink: 0, // Prevent cards from shrinking
// // //           marginLeft: "5vw", // Center the cards a bit
// // //           marginRight: "5vw",
// // //         });
...
// // //         gsap.to(".products-container", {
// // //           scrollTo: {
// // //             x: section.offsetLeft - (window.innerWidth - section.offsetWidth) / 2, // Center the clicked card
// // //             autoKill: false,
// // //           },
// // //           duration: 0.8,
// // //           ease: "power2.out",
...
//       id: "product-green",
//       name: "Ryse",
//       name: "Ryse", // Changed name from Isogold to Ryse as per the image
//       variant: "BCAA / EAA",
//       description: "Fuel your muscles with essential amino acids for recovery.",
//       price: "$45",
//       image: "/product-4.png",
...
//               style={{
//                 background: `radial-gradient(ellipse at center, transparent 40%, ${product.bgColor} 100%)`,
//                 opacity: 0.8, // Adjust opacity for desired intensity of vignette
//               }}
//             ></div>
