        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div ref={detailsCardRef} className="w-full lg:w-5/12 opacity-0">
            <div className="bg-white p-6 md:p-8 rounded-lg shadow-sm border border-gray-100 h-full">
              ...
              <div className="space-y-6">
                <div>
                  <h4 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-2">Office Address</h4>
                  <p className="text-gray-700">80 MARITIME BLVD UNIT 44, ON L6S 0E7</p>
                </div>
                ...
                <div className="space-y-5">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-xs font-medium text-gray-500 uppercase tracking-wider">Call Us On</p>
                      <p className="text-gray-800 font-semibold mt-1">+1 (905) 783-2994</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="bg-red-100 p-3 rounded-full flex-shrink-0">
                    ...
                    <div>
                      ...
                      <p className="text-gray-800 font-semibold mt-1">Buildapenutrition@gmail.com</p>
                    </div>
                  </div>
                </div>
                <div className="border-t border-gray-200"></div>
                {/* <div>
                  <h4 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-3">Social Share</h4>
                  <div className="flex gap-4">
                    <a href="https://www.instagram.com/buildape/" className="bg-gray-100 hover:bg-gray-200 p-3 rounded-full transition-colors" aria-label="Instagram">
                      <img src="img/instagramb.png" alt="Instagram" className="w-5 h-5" />
                    </a>
                    <a href="https://www.tiktok.com/@buildape?_t=8fgf9C3Fx4f&_r=1" className="bg-gray-100 hover:bg-gray-200 p-3 rounded-full transition-colors" aria-label="TikTok">
                      <img src="img/tik-tok.png" alt="TikTok" className="w-5 h-5" />
                    </a>
                  </div>
                </div> */}
  ...
  <div className="flex gap-4">
    ...
    >
      <FaFacebookF className="text-xl" />
          ...
          {/* Contact Form Section */}
          <div ref={formCardRef} className="w-full lg:w-7/12 xl:w-7/12 opacity-0">
            <form action="controller.php" method="post" className="contact-form ps-5 lg:ps-8 xl:ps-10 py-6 pe-6 bg-white rounded-lg shadow-sm h-full">
              <h3 className="text-2xl md:text-3xl font-bold mb-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="label-input-field">
                  ...
                  <input type="text" placeholder="First Name" name="full_name" required className="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent" />
                </div>
                <div className="label-input-field">
                  <label className="block text-sm font-medium mb-1">Last Name</label>
                  <input type="text" placeholder="Last Name" name="last_name" required className="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent" />
                </div>
                <div className="label-input-field">
                  <label className="block text-sm font-medium mb-1">Email</label>
                  <input type="email" name="email" required placeholder="Your email" className="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent" />
                </div>
                <div className="label-input-field">
                  <label className="block text-sm font-medium mb-1">Phone</label>
                  <input type="tel" maxLength="10" placeholder="Your phone" name="phone_no" required className="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent" />
                </div>
                <div className="col-span-full label-input-field">
                  <label className="block text-sm font-medium mb-1">Messages</label>
                  <textarea placeholder="Write your message" rows="2" name="message" className="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"></textarea>
                </div>
                <div className="col-span-full">
                  <div className="g-recaptcha" data-sitekey="6Le1IHEpAAAAANNjpPJ_JMn_vUi2vIExtdxsx5a3"></div>
                </div>
              </div>
              <button type="submit" className="mt-6 hover:bg-primary-600 text-white bg-orange-500 font-medium py-2 px-6 rounded transition duration-300" name="btn_comment">
                Send Message
              </button>
            </form>
          </div>
      ...
      {/* Google Maps Section */}
      <div ref={mapRef} className="container mx-auto px-4 sm:px-6 lg:px-8 mt-10 opacity-0">
