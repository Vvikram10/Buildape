...
// //     // START: बदला हुआ कोड
// //     // 1. हेडर को बताएं कि अगला सेक्शन (TopProduct) ट्रांसपेरेंट हेडर का उपयोग करेगा
// //     window.dispatchEvent(new CustomEvent("header:update", { detail: { style: 'transparent' } }));
// //     // 2. हेडर के एनीमेशन को ट्रिगर करने वाला मूल इवेंट
// //     window.dispatchEvent(new Event("hero:hiding"));
// //     // END: बदला हुआ कोड
...
const Hero = () => {
  ...
  const hideHero = useCallback(() => {
    ...
    gsap.to(heroRef.current, {
      yPercent: -100,
      duration: 0.6, // ✨ बदला हुआ: एनिमेशन को तेज़ किया
      ease: "none",
      onComplete: () => {
        setIsHeroVisible(false);
        setIsAnimating(false);
